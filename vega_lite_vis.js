window.addEventListener('load', function () {
  ...
  // Hero Chart
  vegaEmbed("#hero-chart",      "VEGA-LITE/ai_bubble_hero.vg.json",         { actions: false, renderer: "svg", mode: "vega" }).catch(console.error);
  ...
  vegaEmbed("#who-chart",       "VEGA-LITE/adoption_by_industry.vg.json",    { actions: false, renderer: "svg", mode: "vega" }).catch(console.error);
